...
public class GenericDouble6Var extends BeanSupport {
    ...
    /* Class Constructors */
	public GenericDouble6Var(String h, XmlFact f) throws CloneNotSupportedException {
	...
	public GenericDouble6Var(String h) throws CloneNotSupportedException {
		handlename = new String(h);
		handle     = SMRcomm.getByHandle(handlename);
		if ( ! fact.getStruct().getHost().getServerName().equals("mrc")) {
			if(!handle.addGeneric(fact.getStruct().getStructName() + "." + fact.getVariable(),this)) {
