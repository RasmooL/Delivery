...
public class CurrentCommand {
    ...
    /* Class Constructors */
    public CurrentCommand(String h) {
		handlename = new String(h);
		handle     = SMRcomm.getByHandle(handlename);
		handle.setCommandListener(this);
    }
    public CurrentCommand(String h, SMRobject handle) {
		handlename = new String(h);
		handle.setCommandListener(this);
    }
    ...
    void changeCommand(String cmd, int id, int stat, int stopcond) {
