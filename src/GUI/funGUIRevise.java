...
public class funGUIRevise extends JFrame implements Userfunction {
	private String functionName = "GUIRevise";
	static Rete engine;
	static Odometry odo;
	...
	public Value call(ValueVector vv, final Context c) throws JessException {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					funGUIRevise frame = new funGUIRevise();
			...
			if(checkBoxes[i].isSelected()) {
				...
				try {
					...
					case 0:
						...
						System.out.println("Assert: (goal (waypoint 2))");
						break;
					case 1:
						engine.assertString("(goal (waypoint 6))");
						System.out.println("Assert: (goal (waypoint 6))");
						break;
					case 2:
						engine.assertString("(goal (waypoint 9))");
						System.out.println("Assert: (goal (waypoint 9))");
						break;
					case 3:
						engine.assertString("(goal (waypoint 13))");
						System.out.println("Assert: (goal (waypoint 13))");
						break;
					case 4:
						engine.assertString("(goal (waypoint 15))");
				...
				try {
					...
					case 0:
						...
						System.out.println("Retract: (goal (waypoint 2))");
						break;
					case 1:
						engine.retractString("(goal (waypoint 6))");
						System.out.println("Retract: (goal (waypoint 6))");
						break;
					case 2:
						engine.retractString("(goal (waypoint 9))");
						System.out.println("Retract: (goal (waypoint 9))");
						break;
					case 3:
						engine.retractString("(goal (waypoint 13))");
						System.out.println("Retract: (goal (waypoint 13))");
						break;
					case 4:
